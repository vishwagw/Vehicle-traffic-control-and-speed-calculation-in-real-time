...
b_model = YOLO('./models/traffic_best.pt')
...
while cap.isOpened():
    ...
    if ret:
        ...
        results = b_model.predict(detection_frame, imgsz=640, conf=0.4)
        ...
        cv2.imshow('Drone footage: traffic detector: Live', processed_frame)
